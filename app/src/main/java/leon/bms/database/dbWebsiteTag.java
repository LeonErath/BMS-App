...
public class dbWebsiteTag extends SugarRecord {
    ...
    public dbKurs kurs;
    public dbUser user;
    public dbKursTagConnect dbKursTagConnect;
    ...
    public dbWebsiteTag(String hinzugefuegtAm, int relevanz, String websitetag, int vorkommen, dbKurs kurs, dbUser user, leon.bms.database.dbKursTagConnect dbKursTagConnect) {
    ...
    public leon.bms.database.dbKursTagConnect getDbKursTagConnect() {
        return dbKursTagConnect;
    }

    public void setDbKursTagConnect(leon.bms.database.dbKursTagConnect dbKursTagConnect) {
        this.dbKursTagConnect = dbKursTagConnect;
    }
